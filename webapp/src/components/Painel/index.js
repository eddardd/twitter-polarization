...
import { Container, GraphSection, Svg, SpanHighlight } from './styles';
        ...
        <>
          <Fade>
            <GraphSection>
              ...
              <p>
                Procuramos fazer uma análise do comportamento que diversos
                agentes políticos apresentam na rede social Twitter. O foco da
                nossa visualização está na interação entre usuários. Para
                visualizar essas interações, nós vamos considerar o ato de
                retweet como uma conexão entre dois usuários. Portanto, nós
                agrupamos usuários de mesma ideologia política. Note que a
                definição da ideologia política dos usuários pesquisados segue a
                ideologia partidária levantada em <a href="#ref"> [6]</a>, bem
                como a análise feita por <a href="#ref"> [7]</a>. Incluímos uma
                conexão entre personalidades que se reuitaram. Isso nos permite
                verificar: (i) se os retuites seguem a ideologia política dos
                agentes políticos, (ii) quais usuários conseguem se comunicar
                com diferentes ideologias políticas.
              </p>
              <h5>Ideologia Política e Retuites</h5>
              <p>
                Ao analisarmos os perfis, notamos que{' '}
                <SpanHighlight>
                  {' '}
                  usuários à esquerda tendem a retuitar usuários de esquerda
                </SpanHighlight>
                , assim como os{' '}
                <SpanHighlight>
                  usuários de direita tendem a retuitar usuários de direita
                </SpanHighlight>
                . Exemplos notórios são os perfis do deputado Zeca Dirceu
                (@zeca_dirceu) e do presidente Jair Bolsonaro (@jairbolsonaro).
                Enquanto o primeiro só se comunica com usuários de esquerda
                (portanto, de sua mesma ideologia política), o segundo consegue
                ainda se comunicar com todo o espectro político, apesar da
                predominância entre usuários de direita.
              </p>
              <div className="row">
              ...
              <p>
                <SpanHighlight>
                  O mesmo não se verifica para usuários de centro.
                </SpanHighlight>{' '}
                Por exemplo, veículos de informação tem uma maior
                comunicabilidade entre todo o espectro político, como pode ser
                visto abaixo nas conexões do perfil @folha, ou mesmo nomes de
                centro-direita como o perfil @77_frota. Isso reforça dois
                pontos-chave: (i){' '}
                <SpanHighlight>a imparcialidade</SpanHighlight> de veículos de
                imprensa e de jornalistas, e (ii) o fato de que agentes
                políticos menos radicais{' '}
                <SpanHighlight>tendem a se comunicar</SpanHighlight> com os dois
